...
const BlogPage = () => {
	...
	if (!DataBlogs.data || !DataBlogs.data.metadata.data || !Array.isArray(DataBlogs.data.metadata.data)) {
		return (
	...
	const rows = DataBlogs.data.metadata.data.map((row: IBlog, index: number) => ({
		id: row._id || index,
		...row,
	}));
		...
		<>
			...
			<Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
				...
				<DialogContent dividers>
					...
					<BlogComment idBlog={selectedBlog?._id as string} isCart={false} />
				</DialogContent>
			</Dialog>
		</>
	);
