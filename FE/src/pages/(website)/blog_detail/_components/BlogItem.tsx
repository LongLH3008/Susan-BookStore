			...
			<div className=" border border-[#efefef] p-7">
				...
				<div className="flex divide-x divide-gray-400 *:px-5 justify-center mb-9">
					<p className="text-[#999999]">
						...
						Tác giả : <span className="text-[#707070]">{author?.user_name}</span>
					</p>
					<p className="text-[#999999]">
						<i className="fa-regular fa-calendar-days mr-2"></i>
						Ngày đăng :{" "}
						<span className="text-[#333333]">{FormatDate(dataBlog?.createdAt)}</span>
					</p>
				</div>
				<img src={dataBlog?.blog_image} alt="" className="w-full object-cover h-[40vh] mb-10" />
				<div
