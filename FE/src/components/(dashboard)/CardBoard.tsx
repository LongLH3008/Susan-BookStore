const CardBoard = (props: any) => {
	return (
		<div className="w-72 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-700 dark:border-gray-700">
			<div className={`flex items-center rounded-t-lg ${props?.color}  p-4 text-gray-50`}>
				<i className={`${props?.icon} mr-2 font-bold`}></i>
				<h5 className=" text-xl font-semibold tracking-tight dark:text-white">{props?.title}</h5>
			</div>
