...
const Aside = (props: any) => {
  ...
  return (
    <div
      className={`duration-700 relative ease-in-out transition-all  flex flex-col justify-between gap-3 p-5 h-screen px-3 pb-4 text-[#535353] bg-white dark:bg-gray-800
			${resizeAside ? "w-20" : "w-[20%]"}`}
    >
      <ul className="font-medium *:overflow-hidden">
        <li>
          <img className="p-5 w-[150px]" src={Logo} alt="" />
        </li>
        <li className="">
          <Link to={""}>
