...
const Aside = (props: any) => {
  ...
  return (
    <div
      className={`duration-300 overflow-y-auto relative ease-in-out transition-all  flex flex-col justify-between gap-3 p-5 h-screen px-3 pb-4 text-[#535353] bg-white dark:bg-gray-800
    ...
    >
      <ul className="font-medium *:overflow-hidden">
        ...
        >
          <img
            className="p-5 duration-300 min-w-[80px] w-[70%] object-cover"
            src={Logo}
            alt=""
          />
        </li>
        ...
        <li className="">
          <div
            ...
            className="flex items-center relative h-[50px] px-5 hover:bg-zinc-200 rounded-md"
          >
          ...
          {open && (
            <ul className="bg-gray-50">
              ...
              <li>
                <Link
                  to={"/quan-tri/anh-quang-cao-sale"}
                  className=" flex items-center h-[50px] px-5 relative overflow-hidden hover:bg-zinc-200 rounded-md"
                >
                  <span
                    className={`absolute whitespace-nowrap duration-700 top-1/2 -translate-y-1/2 left-14 ease-in-out ${
