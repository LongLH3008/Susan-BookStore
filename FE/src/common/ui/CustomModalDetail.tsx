...
export const CustomModalDetail : FlowbiteModalTheme = {
	root: {
	...
	content: {
		...
		inner: "relative <max-h-fit></max-h-fit> overflow-hidden rounded-lg bg-white shadow",
	},
	body: {
		base: "overflow-auto px-6 pb-5",
		popup: "pt-0",
	},
	header: {
		base: "h-10",
