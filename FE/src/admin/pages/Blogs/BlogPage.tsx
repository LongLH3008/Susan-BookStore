...
import PageLayout from '@/admin/layouts/PageLayout';
            ...
            <div className="px-10 sm:ml-64 h-[100vh]">
                ...
                <form className="max-w-sm mx-auto mb-4 w-100">
                    ...
                    <div className="mb-5 w-full border-b-2 border-gray-900 py-4">
                        ...
                        <div id="default-modal" tabIndex={-1} className={` ${showModal ? '' : 'hidden'} overflow-y-auto overflow-x-hidden fixed mt-[10%] ml-[35%] top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
                    ...
                    <Link to={'/'} className="mx-4 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Preview</Link>
