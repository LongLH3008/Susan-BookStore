	...
	return (
		<div className="relative flex flex-col gap-4">
            ...
            <div className="flex *:w-full gap-4">
                <CustomFloatingField id="firstname_checkout" label="First name (optional)" isValidated required message="Invalid Name" />
                <CustomFloatingField id="lastname_checkout" label="Last name" isValidated required message="Invalid character" />
            </div>
            <CustomFloatingField id="address_checkout" label="Address" required isValidated message="Invalid character" />
            <CustomFloatingField id="apartment_checkout" label="Apartment, suite, etc, (optional)" isValidated message="Invalid character" />
