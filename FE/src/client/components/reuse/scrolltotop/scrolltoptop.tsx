...
const ScrollToTop = () => {
	...
	return (
		<button
            className={`hidden lg:grid fixed right-[5%] bottom-[20%] w-[54px] h-[54px] hover:border-[#00BFC5] hover:text-[#00BFC5] hover:duration-100 place-items-center border-2 border-zinc-300 text-zinc-800 ease-in duration-300 
