        ...
        <div className=" border border-[#efefef] p-7">
          ...
          <div className="flex divide-x divide-gray-400 *:px-5 justify-center mb-9">
            <p className="text-[#999999]">
              ...
              Posted By:{" "}
              <span className="text-[#707070]">Susan Demo Admin</span>
            </p>
            <p className="text-[#999999]">
          ...
          <div className="*:mt-10 *:text-[#707070]">
            <div className="py-7 px-12 border ml-10 border-l-[7px] border-l-[#00bfc5] *:text-[12px]">
              <p>
                Lorem ipsum deleniti repellendus nam deserunt vitae ullam amet
                quos! Nesciunt, quo. Lorem, ipsum dolor. Lorem ipsum dolor sit
                amet consectetur adipisicing elit. Quod, vitae numquam!
                VitaeLorem ipsum dolor sit amet consectetur adipisicing elit.
                Sed, ipsum deleniti repellendus nam deserunt vitae ullam amet
                quos! Nesciunt, quo. Lorem, ipsum dolor.
              </p>
            </div>
            <p>
              ...
              ullam voluptatibus asperiores fugit ea soluta consectetur adipisci
              enim, impedit odit quisquam, ut, numquam voluptatem quas cum!
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod,
              vitae numquam! Vitae alias ullam voluptatibus asperiores fugit ea
              soluta consectetur adipisci enim, impedit odit quisquam, u Lorem
              ...
              impedit odit quisquam, ut, numquam voluptatem quas cum!
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed,
              ipsum deleniti repellendus nam deserunt vitae ullam amet quos!
