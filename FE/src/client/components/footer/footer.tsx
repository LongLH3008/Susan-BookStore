			...
			<div className="grid lg:grid-cols-2 gap-4 py-[80px] md:py-[100px]">
				...
				<div className="grid sm:grid-cols-3 gap-4 ">
					<div className="grid *:pb-5 *:sm:pb-9">
						<p className="font-bold text-[#292929] text-[16px]">Business Hours</p>
						<p>Mon - Fri: 8AM - 10PM</p>
						<p>Sat: 9AM-8PM</p>
						<p>Sun: Closed</p>
					</div>
					<div className="grid *:pb-4">
						<p className="font-bold text-[#292929] text-[16px] mb-4">Footer Menu</p>
						<Link to="/" className="hover:text-[#00BFC5]">Home</Link>
						<Link to="/" className="hover:text-[#00BFC5]">Shop</Link>
						<Link to="/" className="hover:text-[#00BFC5]">Blog</Link>
						<Link to="/" className="hover:text-[#00BFC5]">About</Link>
						<Link to="/" className="hover:text-[#00BFC5]">Contact</Link>
					</div>
					<div className="grid *:pb-4">
						<p className="font-bold text-[#292929] text-[16px] mb-4">Extras Menu</p>
						<Link to="/" className="hover:text-[#00BFC5]">About Us</Link>
						<Link to="/" className="hover:text-[#00BFC5]">Our Office</Link>
						<Link to="/" className="hover:text-[#00BFC5]">Delivery</Link>
						<Link to="/" className="hover:text-[#00BFC5]">Our Store</Link>
						<Link to="/" className="hover:text-[#00BFC5]">Guarantee</Link>
					</div>
				</div>
			</div>
			<div className="lg:flex lg:justify-between sm:grid sm:grir-cols-12 sm:gap-4 border-t border-zinc-200 py-7 ">
