		...
		<>
			...
			<div className="xl:px-[11.5%] 2xl:px-[17.5%] h-[635px] flex justify-center *:h-full py-[100px]">
				<div className="w-[540px] h-full bg-[#f3f3f3] flex flex-col justify-between items-center px-[40px] py-[37px]">
					...
					<form
						action=""
						className="mt-6 bg-white shadow-lg p-[30px] w-full h-[270px] flex flex-col justify-between *:text-[14px] *:text-zinc-900"
					>
							<CustomFloatingField id="email_login" label="Email" isValidated message="Invalid Email" />
							<CustomFloatingField id="password_login" type="password" label="Password" isValidated message="Invalid Email" />
