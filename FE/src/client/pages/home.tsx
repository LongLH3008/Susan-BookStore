			...
			>
				<div className="z-10 flex flex-col justify-between items-center h-full w-[80%] md:w-[60%]  lg:w-[40%]">
					...
					<p className="text-[14px] text-center leading-7 text-zinc-500">
						"Books are the portals to infinite worlds, where imagination reigns supreme and knowledge knows
						no bounds. Let the wisdom of the ages and the creativity of authors
						guide your mind and spirit. Open a book today, and unlock the treasures that await within!"
					</p>
