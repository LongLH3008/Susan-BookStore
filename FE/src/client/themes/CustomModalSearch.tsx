...
export const customModalSearch: FlowbiteModalTheme = {
	...
	header: {
		...
		close: {
			base: "absolute right-2 top-2 text-gray-400 bg-transparent hover:bg-zinc-500 hover:text-white rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center",
			icon: "h-5 w-5",
		},
	},
	footer: {
